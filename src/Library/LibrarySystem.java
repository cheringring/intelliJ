...
public class LibrarySystem { //도서관 관리 시스템
    ...
    long userId = 2000L;
    LibrarySystem(){ACCESSS = Library.getACCESS();}
    public void signIn (String userName){users.add(new User(userId++, userName));}//회원가입
...
class Book{
    private long id;
    private String name;
    Book(long id, String name){this.id = id; this.name = name;}
...
class User{
    ...
    User(long id, String name){this.name = name; this.id = id;}
    public long getId() {return id;}
    public String getName() {return name;}


    public void borrowBook(Book book){books.add(book);}//대출
